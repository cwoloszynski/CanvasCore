...
public final class AvatarsController {
	...
	fileprivate let queue = DispatchQueue(label: "com.usecanvas.canvas.avatarscontroller", attributes: [])
	...
	public func fetchImage(id: String, url: URL, completion: @escaping Completion) -> Image? {
